...
// 色データ（インデックスで対応）
//const fillColors = ["#FFD1DC", "#C1E1FF", "#FFFAC1", "#E1C1FF", "#D1FFC1", "#FFDDC1", "#C1C1E5"];
const fillColors = ["#FFF", "#FFF", "#FFF", "#FFF", "#FFF", "#FFF", "#FFF"];
const strokeColors = ["#FF4466", "#1E90FF", "#FFD700", "#8A2BE2", "#32CD32", "#FF8C00", "#101077"];
